      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-6">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 items-center justify-center">
            <button className="group relative px-8 py-4 bg-transparent border-2 border-accent text-accent font-medium rounded-md transition-all duration-300 hover:bg-accent hover:text-accent-foreground hover:shadow-xl hover:shadow-accent/25 min-w-[180px] transform hover:scale-105">
            ...
            <button className="group relative px-8 py-4 bg-transparent border border-muted text-muted-foreground font-medium rounded-md transition-all duration-300 hover:bg-secondary hover:text-foreground hover:border-accent/50 hover:shadow-lg min-w-[180px] transform hover:scale-105">
